...
begin
  select coalesce(array_agg(id), '{}'::uuid[]) into group_ids from public.groups where name like 'verify-campus-lead-coach-campus-%' or name like 'verify-cross-campus-counseling-%';
