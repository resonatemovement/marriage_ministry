...
export function eligibleCampusLeadCoachTeams(coachTeams: TeamOption[], campusId: string | null) {
  return coachTeams.filter((team) => team.active !== false && team.campusId === campusId);
}
