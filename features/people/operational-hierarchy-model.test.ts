...
describe("operational hierarchy", () => {
  it("places counselors under their coach before their Campus Lead", () => {
    const hierarchy = buildOperationalHierarchy([team("lead", "campus_lead"), team("coach", "coach"), team("counselor", "counselor")], [{ campusLeadId: "lead", coachId: "coach" }], [{ coachId: "coach", counselorId: "counselor" }]);
  ...
  it("omits a Counselor without a coach from the operational hierarchy", () => {
    const hierarchy = buildOperationalHierarchy([team("lead", "campus_lead"), team("counselor", "counselor")], [], []);
