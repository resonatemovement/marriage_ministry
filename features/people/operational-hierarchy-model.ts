...
export function buildOperationalHierarchy(teams: OperationalHierarchyTeam[], campusLeadCoach: Array<{ campusLeadId: string; coachId: string }>, campusLeadCounselor: Array<{ campusLeadId: string; counselorId: string }>, coachCounselor: Array<{ coachId: string; counselorId: string }>): OperationalHierarchy {
